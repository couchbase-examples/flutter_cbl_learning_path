...
class RouteState extends Equatable {
  ...
  const RouteState(
      ...
      this.route = const ScreenRoute(
          routeToScreen: RouteToScreen.none, projectId: '', auditId: '')});

  const RouteState.unknown()
      : this(
            status: AuthenticationStatus.unknown,
            user: User.empty,
            route: const ScreenRoute(
                routeToScreen: RouteToScreen.none, projectId: '', auditId: ''));
  ...
  const RouteState.developerInfo()
      : this(
            ...
            user: User.empty,
            route:
                const ScreenRoute(routeToScreen: RouteToScreen.developerInfo));
  ...
  const RouteState.userProfileEditor()
      : this(
            ...
            user: User.empty,
            route: const ScreenRoute(
                routeToScreen: RouteToScreen.userProfileEditor));
  ...
  const RouteState.replicatorConfig()
      : this(
            ...
            user: User.empty,
            route: const ScreenRoute(
                routeToScreen: RouteToScreen.replicatorConfig));
